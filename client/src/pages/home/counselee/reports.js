      ...
      <div className="bg-gray-500 h-screen">
        ...
        <div className="flex bg-gray-900 items-center justify-between">
          <div className='text-white font-semibold'>
            <h1 className='p-4 text-3xl'>My Reports</h1>
          </div>
        ...
        <div className='flex items-center justify-between'>
          <div className='flex items-center'>
            ...
            <Link href='/home/counselee/reports'><button className='bg-green-500 border p-2 rounded-sm border-green-500 hover:bg-green-400 hover:border-green-400'>Reports</button></Link>
            <Link href='/home/counselee/followup'><button className='bg-white border p-2 rounded-sm border-gray-200 hover:bg-green-400 hover:border-green-400'>Follow-ups</button></Link>
          </div>
      </div>
